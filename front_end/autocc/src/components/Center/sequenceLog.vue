...
const data = [
    ...
    { id: "6",  text: "第四步", parent: "2", status: 0, type: "chord" },
    { id: "7",  text: "第五步", parent: "3", status: 1, type: "circular" },
    { id: "8",  text: "第四步", parent: "3", status: 2, type: "radial" }
  ];
...
onMounted(() => {
   ...
   * 全局颜色面板 & 其他全局变量
   ***********************************************/
  const runColorPanel = ["#66c2a4", "#fc8d62", "#ce5c5d"];
...
`;
  ...
  const spacingY = 100;  // 横向间距 (控制水平方向)
